...
$conteudoRequerimento .= "<p>".utf8_encode($nome).", portador do título eleitoral nº ".$titulo.", devidamente qualificado no formulário de pré-atendimento ".$tituloNet.", solicito o processamento do pedido.</p>";
