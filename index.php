    ...
    <div class="col-lg-8 description-block">
        <div class="description-item">
            <div class="row">
                ...
                <div class="col-lg-11"><div class="vertical-center">Primeiro faça a solicitação no Título Net, <a href="http://www.tse.jus.br/eleitor/titulo-de-eleitor/pre-atendimento-eleitoral-titulo-net/titulo-net" target="_blank">clicando aqui</a>. Atenção: anote o número do protocolo gerado. É necessário apenas para as opções de Alistamento, Transferência e Revisão/Restabelecimento de Título Cancelado.</div></div>
            </div>
        </div>
        <div class="description-item">
            <div class="row">
