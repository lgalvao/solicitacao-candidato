    ...
    <form id="formulario" method="GET" action="formulario.php">
        <div class="card">
            <div class="card-body">
                ...
                <p>1.
                    O teor e a integridade dos documentos digitalizados e enviados para Justiça Eleitoral por meio do Formulário Eletrônico são de responsabilidade do requerente, que responderá nos termos da legislação civil, penal e administrativa por eventuais fraudes.</p>
                ...
                <p><strong>6. Falsidade Ideológica : Omitir, em documento público ou particular, declaração que dele devia constar, ou nele inserir ou fazer inserir declaração falsa ou diversa da que devia ser escrita, para fins eleitorais: Pena ¿ reclusão até cinco anos e pagamento de 5 a 15 dias-multa, se o documento é público, e reclusão até três anos e pagamento de 3 a 10 dias-multa, se o documento é particular (Art. 350 do Código Eleitoral)." Cidade, data e hora.</strong></p>
            </div>
        </div>
